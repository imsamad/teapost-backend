...
const myCollections = (0, utils_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user._id;
    const query = StoryCollection_1.default.find({
        user,
    });
    (0, pagination_1.default)(req, res, next, { query, label: 'mycollections' });
}));
