...
const ctrl = (0, utils_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    let author = req.user._id, addAuthors = ((_a = req.body) === null || _a === void 0 ? void 0 : _a.addAuthors) || [], removeAuthors = ((_b = req.body) === null || _b === void 0 ? void 0 : _b.removeAuthors) || [];
    let story = yield Story_1.default.findOne({ _id: req.params.storyId, author });
    if (!story)
