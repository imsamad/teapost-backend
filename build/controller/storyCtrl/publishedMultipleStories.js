...
const publishedMultipleStories = (0, utils_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    const isPublishMany = ((_c = (_b = (_a = req === null || req === void 0 ? void 0 : req.originalUrl) === null || _a === void 0 ? void 0 : _a.split('/')) === null || _b === void 0 ? void 0 : _b.pop()) === null || _c === void 0 ? void 0 : _c.toLowerCase()) == 'publishedmany';
    ...
    const promiseResolved = yield Promise.allSettled(stories.map((story) => {
        if (!isPublishMany) {
    ...
    return res.json({
        ...
        message: promiseResolved
            ...
            .map((promise) => promise === null || promise === void 0 ? void 0 : promise.reason),
    });
}));
...
exports.default = [(0, validateSchemaMdlwr_1.default)(schema), publishedMultipleStories];
