...
exports.readAbleDate = exports.formatAMPM = exports.monthList = exports.sendTokens = exports.getToken = exports.saveImageLocally = exports.validateYupSchema = exports.ErrorResponse = exports.trimInside = exports.typeOf = exports.createHash = exports.randomBytes = exports.readingTime = exports.getRndInteger = exports.asyncHandler = exports.lorem = exports.randomDate = exports.capitalFirst = exports.stars = void 0;
...
const stars = (val = 1) => '**********'.repeat(val);
exports.stars = stars;
const lorem_ipsum_1 = require("lorem-ipsum");
const capitalFirst = (str) => str.charAt(0).toUpperCase() + str.slice(1);
exports.capitalFirst = capitalFirst;
const randomDate = (start = new Date(2000, 0, 1), end = new Date()) => new Date(start.getTime() + Math.random() * (end.getTime() - start.getTime()));
...
const sendTokens = (user, statusCode, res, message) => __awaiter(void 0, void 0, void 0, function* () {
    const resData = Object.assign({ status: 'ok', message }, (0, exports.getToken)(user));
