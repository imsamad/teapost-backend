...
router.get('/google_login', authCtrl_1.default.googleLoginHndlr);
router.get('/google_cb', authCtrl_1.default.googleRedirectCtrl);
router.get('/oauthtoken/:userId', authCtrl_1.default.getOAuthToken);
...
router.delete(['/', '/deleteMe', '/deactivate'], authCtrl_1.default.deleteMe);
